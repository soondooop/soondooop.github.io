(function ($) {
    ...
    $.fn.sakura = function (options) {
        ...
        var sakura = $('<div class="' + options.className[Math.floor(Math.random() * options.className.length)] + '" />');
        ...
        var petalCreator = function () {
            ...
            var petal = $('<div class="' + options.className[Math.floor(Math.random() * options.className.length)] + '" />');
